      ...
      <div className="w-full h-full border border-gray-300 dark:border-gray-600 dark:shadow-gray-500 shadow-sm p-4 mt-4 rounded-lg">
        ...
        <div className="grid gap-4">
          ...
          <div className="grid grid-cols-[1fr_auto] items-start">
            <div>
              <h1 className="font-semibold md:text-lg">Software Developer</h1>
              <h2 className="text-xs md:text-base">Iloilo City</h2>
            </div>
            <span className="ml-2 p-1 border rounded-lg text-xs font-normal md:text-base">2028</span>
          </div>
          ...
          <div className="grid grid-cols-[1fr_auto] items-start">
            ...
            <span className="ml-2 p-1 border rounded-lg text-xs font-normal md:text-base">2027</span>
          </div>
